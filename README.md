...
> This section is the portfolio audit entry point for **neural-network-from-scratch-cpp**. It describes an engineering promotion path; it is not a claim that the repository is already production-authorized.

[![CI](https://img.shields.io/github/actions/workflow/status/CoreyLeath-code/neural-network-from-scratch-cpp/ci.yml?branch=main&label=CI)](https://github.com/CoreyLeath-code/neural-network-from-scratch-cpp/actions) [![License](https://img.shields.io/github/license/CoreyLeath-code/neural-network-from-scratch-cpp)](https://github.com/CoreyLeath-code/neural-network-from-scratch-cpp/blob/main/LICENSE)
